---
sidebar_label: startree-percentage-rule-percentile-query-dx
position: 54
---
...
|percentageChange|Percentage threshold. If the percentage change is above this threshold, detect an anomaly.<br></br>In ratio. Eg 0.1 means 10 percent. [Learn more](https://dev.startree.ai/docs/startree-enterprise-edition/startree-thirdeye/reference/operators/anomaly-detector/percentage).|-|
