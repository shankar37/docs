---
description: In this Apache Pinot guide, we'll learn how visualise data using the Dash web framework.
---

# How to connect to Dash

In this guide you'll learn how to visualise data from Apache Pinot using Plotly's [Dash](https://github.com/plotly/dash) web framework.
