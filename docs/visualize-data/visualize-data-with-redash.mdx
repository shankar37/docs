...
![Redash Settings - Data Sources](./redash-settings-data-sorce.png)
...
1. In Redash, go to Dashboards > New Dashboards, and then add the widgets to your dashboard. For example, by adding the three visualizations from the [three example queries](#example-python-queries) above, you create a Baseball stats dashboard.

![Baseball stats dashboard](./baseball-stats-dashboard.png)

For more information, see [Dashboards](https://redash.io/help/user-guide/dashboards) in Redash documentation.
